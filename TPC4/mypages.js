...
<html>
    ...
    <body>
        ...
        pagHTML+=`                    
                    ...
                    <br/>
                    <button type="submit" class="w3-btn w3-hover-light-grey w3-green w3-round-xlarge w3-right w3-large w3-padding-large">Submit</button>
                </fieldset>
            </form>
        ...
        pagHTML+=`
            ...
            <img src="/public/todo.jpg" alt="Todo clipart" width=20% class="w3-round">
        </div>
        <footer class="w3-container w3-green">
            <address>Generated by a97141 in ${d}</address>
        </footer>
    </body>
</html>
    `
...
<html>
    ...
    <body>
        ...
        <footer class="w3-container w3-green">
            <address>Generated by a97141 in ${d} - <b>[ <a href="http://localhost:7777/">Back</a> ]</b></address>
        </footer>
    </body>
</html>
`
...
<html>
    ...
    <body>
        ...
        pagHTML+=`                    
                    ...
                    <br/>
                    <button class="w3-btn w3-hover-light-grey w3-green w3-round-xlarge w3-large w3-padding-large w3-right" type="submit">Submit</button>
                </fieldset>
            </form>
        </div>
        <footer class="w3-container w3-green">
...
<html>
    ...
    <body>
        ...
        <fieldset>
            ...
            <br/>
            <button class="w3-btn w3-hover-light-grey w3-green w3-round-xlarge w3-right w3-large w3-padding-large" type="submit">Submit</button>
        </fieldset>
        </form>
        <footer class="w3-container w3-green">
            <address>Generated by a97141 in ${d} - <b>[ <a href="http://localhost:7777/">Back</a> ]</b></address>
