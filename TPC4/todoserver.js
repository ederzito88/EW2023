...
var todoServer = http.createServer(function (req, res) {
    ...
    if(static.staticResource(req)){
        ...
        switch(req.method){
            case "GET": 
                if(req.url=="/" || req.url == "/tasks"){
                     axios.get("http://localhost:3000/tasks")
                         .then(response => {
                            ...
                            .then(respuser => {
                                ...
                                res.write(mypages.homePage(tasks,users,d))
                                res.end()
                            })
                            .catch(erro => {
                                res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                    ...
                    axios.delete("http://localhost:3000/tasks/" + idTask)
                        .then( response => {
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                            res.write(mypages.confirmPage("The task has been removed"))
                            res.end()
                        })
                        .catch(function(erro){
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                        ...
                        .then( response => {
                            ...
                            axios.put('http://localhost:3000/tasks/'+task.id,{
                                ...
                                .then(resp => {
                                    ...
                                    res.write(mypages.confirmPage("The task "+task.what+" done !!"))
                                    res.end()
                                }).catch(error => {
                                    console.log('Erro: ' + error);
                                    res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                                    res.write(mypages.errorPage("Unable to add task...</p>"))
                                    res.end()
                                })
                        })
                        .catch(function(erro){
                    ...
                    axios.get("http://localhost:3000/users/")
                        .then( response => {
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                            res.write(mypages.addUser(d))
                            res.end()
                        })
                        .catch(function(erro){
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                            res.write(mypages.errorPage(`Could not get list of users... Erro: ` + erro))
                            res.end()
                        })
                ...
                if(req.url=="/" || req.url=="/tasks"){
                    ...
                    collectRequestBodyData(req, result => {
                        ...
                        if(result){
                            ...
                            .then(resp => {
                                res.writeHead(201, {'Content-Type': 'text/html;charset=utf-8'})
                                res.write(mypages.confirmFormPage(result,d))
                                res.end()
                            }).catch(error => {
                                console.log('Erro: ' + error);
                                res.writeHead(201, {'Content-Type': 'text/html;charset=utf-8'})
                                res.write(mypages.errorPage("Unable to insert task..."))
                                res.end()
                            })
                        }
                        else{
                            res.writeHead(201, {'Content-Type': 'text/html;charset=utf-8'})
                            res.write(mypages.errorPage("Unable to collect data from body..."))
                            res.end()
                        }
                    }) 
                    })
                    .catch(erro => {
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                            res.write(mypages.errorPage("<p>Unable to get list of tasks... Erro: " + erro))
                            res.end()
                    })  
                        ...
                        .then( response =>{
                            ...
                            collectRequestBodyData(req, result => {
                                if(result){
                                    ...
                                    .then(resp => {
                                        res.writeHead(201, {'Content-Type': 'text/html;charset=utf-8'})
                                        res.write(mypages.confirmUserFormPage(new_user,d))
                                        res.end()
                                    }).catch(error => {
                                        console.log('Erro: ' + error);
                                        res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                                        res.write(mypages.errorPage("Unable to insert user..."))
                                        res.end()
                                    })
                                }
                                else{
                                    res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                                    res.write(mypages.errorPage("Unable to collect data from body...</p>"))
                                    res.end()
                                }
                            }) 
                    })
                    .catch(erro => {
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                            res.write(mypages.errorPage("Unable to get list of tasks... Erro: " + erro))
                        res.end()
                    })  
                    ...
                    collectRequestBodyData(req, result => {
                        if(result){
                            axios.put('http://localhost:3000/tasks/' + idTask, {
                                ...
                                .then(resp => {
                                    res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                                    res.write(mypages.confirmPage("Registo alterado:" + JSON.stringify(resp.data)))
                                    res.end()
                                })
                                .catch(error => {
                                    console.log('Erro: ' + error);
                                    res.writeHead(500, {'Content-Type': 'text/html;charset=utf-8'})
                                    res.write(mypages.errorPage("Unable to insert record..."))
                                    res.end()
                                });
                        }
                        else{
            ...
            default: 
                res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                res.write(mypages.errorPage( req.method + " unsupported in this server."))
                res.end()
        }
    }
})
